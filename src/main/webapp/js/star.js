...
jQuery.fn.rater = function (options) {
    ...
    var settings = {
        ...
        title_format: null,
        info_format: null,
        image: 'https://happymama.oss-cn-beijing.aliyuncs.com/stars.jpg',
        imageAll: 'https://happymama.oss-cn-beijing.aliyuncs.com/stars-all.gif',
        defaultTips: true,
        clickTips: true,
        width: 24,
        height: 24
...
$(function () {
    var options = {
        ...
        info_format: function (value) {
            ...
            switch (value) {
                case 1 :
                    info = '<div class="info-box">1分&nbsp;很不满意<div>宝宝护理技能和工作态度都非常差，太令人失望了！</div></div>';
                    break;
                case 2 :
                    info = '<div class="info-box">2分&nbsp;不满意<div>宝宝护理技能和工作态度不好，不能满足要求。</div></div>';
                    break;
                case 3 :
                    info = '<div class="info-box">3分&nbsp;一般<div>宝宝护理技能和工作态度感觉一般。</div></div>';
                    break;
                case 4 :
                    info = '<div class="info-box">4分&nbsp;满意<div>宝宝护理技能和工作态度都比较满意，符合我的期望。</div></div>';
                    break;
                case 5 :
                    info = '<div class="info-box">5分&nbsp;非常满意<div>我很喜欢！宝宝护理技能和工作态度都很满意，太棒了！</div></div>';
                    break;
                default :
                    info = value;
                    break;
