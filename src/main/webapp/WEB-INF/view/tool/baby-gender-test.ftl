...
<head data-gc="">
    ...
    <link rel="stylesheet" type="text/css" href="${base}/css/test/css.css"/>
    <link rel="stylesheet" type="text/css" href="${base}/css/test/reset.css"/>
    <script type="text/javascript" src="${base}/js/test/rem.js"></script>
...
<script src="${base}/js/test/index.js" type="text/javascript" charset="utf-8"></script>
