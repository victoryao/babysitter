...
<head>
    ...
    <script type="text/javascript" src="${base}/js/star.js"></script>
    <link rel="stylesheet" href="${base}/css/main.bundle.css">
    <link rel="stylesheet" href="${base}/css/footer.css">
    <link rel="stylesheet" href="${base}/css/star.css">
...
<body>
<form method="post" action="${base}/employee/addComment.do" enctype="multipart/form-data" accept-charset="utf-8">
        ...
        <section class="scroller"
            ...
            <section class="publish-box">
                ...
                <section class="line-viewer"
                         style="margin-left: 0.3rem; padding-left: 0px; padding-top: 0.35rem; padding-bottom: 0.05rem;">
                    <section class="custom-textarea">
                    <textarea maxlength="1000" placeholder="阿姨服务的怎么样呢？写评价告诉我们吧。"
                              class="has-margin-left" name="content"
                              style="color: rgb(178, 184, 194); height: 300px;" required></textarea>
                    </section>
                </section>
                <div id="wrapper">
                    <div id="container">
    ...
    <input type="hidden" id="fileType" name="fileType" value="employeeType">
    <input type="hidden" id="contextBase"  value="${contextPath}">
    <input type="hidden" id="StarNum" name="score" value="5">
